...
contract Crowdsale is Owned {
    ...
    function Crowdsale (
        ...
        fundingGoal = _fundingGoalInEthers * 1 ether; //목표금액
        price = 1 ether / _amountOfTokenPerEther; //토큰기본가격
        transferableToken = _transferableToken; //전송가능토큰
        tokenReward = OreOreCoin(_addressOfTokenUsedAsReward);  //지불에 사용할 토큰
    }
